...
async def cmd_help(message: types.Message):
    global request
    request = dict()
    await message.answer("""Поиск задачи, бланк помощи. Для того, чтобы найти задачу нужно выполнить такую инструкцию:
    1) Выбираем команду поиск search, чтобы запустить поиск.
    2) Выбираем команду выбор тем theme, чтобы найти тему и выбираем нужную для вас тему.
    3) Выбираем команду выбор сложности solution, находим сложность и выбираем её.
    4) Выбираем команду выгрузка задач list, которая выводит информацию по задачам.
    5) Команда back, возвращает нас обратно к инструкции.""")
